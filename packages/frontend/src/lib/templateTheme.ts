...
const SHELL_VARS: Record<string, SlotMap> = {
  ...
  atelier: { bg: '--at-paper', ink: '--at-ink', accent: '--at-accent', muted: '--at-tape' },
  nocturne: { bg: '--nc-bg', ink: '--nc-ink', accent: '--nc-accent', muted: '--nc-star' },
  deco: { bg: '--dc-ivory', ink: '--dc-ink', accent: '--dc-emerald', muted: '--dc-band' },
...
export const FONT_HREFS: Record<string, string> = {
  ...
  atelier: 'https://fonts.googleapis.com/css2?family=Fraunces:ital,opsz,wght@0,9..144,300;0,9..144,400;0,9..144,500;1,9..144,400;1,9..144,500&family=Hanken+Grotesk:wght@400;500;600;700&display=swap',
  nocturne: 'https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,400;0,500;0,600;0,700;1,500;1,600&family=Manrope:wght@400;500;600;700;800&family=JetBrains+Mono:wght@400;500;600&display=swap',
  deco: 'https://fonts.googleapis.com/css2?family=Poiret+One&family=Jost:wght@400;500;600;700&display=swap',
...
const FONT_DISPLAY: Record<string, string> = {
  ...
  atelier: "'Fraunces', Georgia, serif",
  nocturne: "'Cormorant Garamond', Georgia, serif",
  deco: "'Poiret One', system-ui, sans-serif",
...
const FONT_BODY: Record<string, string> = {
  ...
  atelier: "'Hanken Grotesk', system-ui, sans-serif",
  nocturne: "'Manrope', system-ui, sans-serif",
  deco: "'Jost', system-ui, sans-serif",
