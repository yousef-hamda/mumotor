      ...
      '@graph': [
        {
          ...
          description:
            'Mumotor is an all-in-one, no-code website builder and booking platform built specifically for driving instructors and small driving schools. Trilingual (Hebrew, Arabic, English) with RTL support.',
          slogan: 'Websites & booking for driving instructors',
        ...
        },
        {
          ...
          name: 'Mumotor',
          alternateName: 'Mumotor website builder for driving instructors',
          ...
          featureList: [
            ...
            'Lesson packages and pricing in local currency',
            'Student reviews and testimonials',
            'Automatic student emails and daily schedule report',
            'Trilingual Hebrew / Arabic / English with RTL',
          ...
          offers: {
            ...
            price: '199',
            priceCurrency: 'ILS',
            description: 'One simple plan — ₪199 per month, everything included. Cancel anytime.',
          },
