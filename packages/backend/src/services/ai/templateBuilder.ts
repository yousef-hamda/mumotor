...
window.dsBook=(function(){
  ...
  function ok(){panel().innerHTML='<div class="book-ok"><div class="tick">&#10003;</div><h3 style="font-family:var(--font-h)">Lesson booked!</h3><p class="book-note">See you on '+state.date+' at '+state.time+'. We\\'ll send you a reminder before your lesson.</p><button class="book-btn" style="margin-top:14px" onclick="dsBook.renderDates()">Book another</button></div>';}
