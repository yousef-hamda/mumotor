...
- **Landing demo video** — the homepage's **"Watch the demo"** opens a ~59s Apple-keynote-style product tour built from the real UI (`public/media/marketing.mp4`), replacing the old "live demo" link.
